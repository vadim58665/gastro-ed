...
**Goal:** Scaffold an LLM-maintained wiki inside the УмныйВрач repo with two domains (medical + project), convention schema, and skills for ingest/lint operations.
