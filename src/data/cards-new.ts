...
export const newCards: Card[] = [
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          "Ванкомицин per os — стандарт лечения C. difficile. Именно перорально, не внутривенно!",
      },
      {
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          "Лактулоза окисляет NH3 в NH4+ в кишечнике, предотвращая всасывание токсичного аммиака в кровь.",
      },
      {
  ...
  },
  {
    ...
    isMyth: false,
    explanation:
      "Смертность при кровотечении из варикозных вен пищевода — 30%. Это ведущая причина смерти при циррозе. Профилактика — пропранолол + лигация.",
  },
  {
    id: "mf-bad-2",
    type: "myth_or_fact",
  ...
  },
  {
    ...
    isMyth: true,
    explanation:
      "Приём мультивитаминов ассоциирован с повышенным риском смерти. Регулярный приём витаминов E и A повышает риск онкологии.",
  },
  {
    id: "mf-vitamin-3",
    type: "myth_or_fact",
    ...
    isMyth: true,
    explanation:
      "Витамин С не влияет на течение ОРВИ и время выздоровления. Симптомы ОРВИ вызываются цитокинами, а не вирусом.",
  },
  {
    id: "mf-vitamin-4",
    type: "myth_or_fact",
    ...
    isMyth: false,
    explanation:
      "Исследования показали увеличение риска рака лёгких на 30-40% при регулярном приёме витаминов B6 и B12.",
  },
  {
    id: "mf-diag-2",
    type: "myth_or_fact",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: false,
        explanation: "Основной механизм — окисление NH3 в NH4+, предотвращая всасывание аммиака.",
      },
      {
  ...
  },
  {
    ...
    explanation:
      "Кровотечение из варикозных вен пищевода — 30% смертность, ведущая причина смерти при циррозе.",
  },
  {
    id: "fb-bad-1",
    type: "fill_blank",
    ...
    options: [
      {
        ...
        isCorrect: true,
        explanation:
          "Бронзовая кожа + диабет + гепатомегалия + высокий ферритин — «бронзовый диабет» (гемохроматоз). Лечение — кровопускание + дефероксамин.",
      },
      {
